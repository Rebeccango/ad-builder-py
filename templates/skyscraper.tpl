...
<div id='container' class='container_common'  >
    <div id='image_container1' class='image-wrapper1'>
            <amp-img class='image' id='image_1' src='{{ img }}' width="160" height="300"></amp-img>
            <amp-img class='image' id='image_2' src='{{ img }}' width="160" height="300"></amp-img>
    </div>
    <div id='logo_container' class='logo_container_common' >
            <amp-img id='logo' class='animate_logo' src='http://go.prophix.com/assets/images/ads/prophix-logo.svg' alt='Prophix' width="140" height="38"></amp-img>
    </div>
    <div id='copy_container' class='text_container_common' >
            <div class='copy copy_color_font copy_fade_end_3'>
                <amp-fit-text min-font-size="6" max-font-size="26" layout="fill">{{ copy }}</amp-fit-text>
            </div>
        ...
        <div id='cta_container' class='animate_cta_updown'>
            <div id='cta_text_container' class='cta_text_with_bg zindex_order_4'>
                <amp-fit-text min-font-size="6" max-font-size="14" layout="fill" id='cta'>{{ cta }}</amp-fit-text>
            </div>
        </div>
</div>
</body>
