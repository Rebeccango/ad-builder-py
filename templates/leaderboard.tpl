...
<div id="container">
        <div id="logo_container">
            <amp-img id="logo" src='http://go.prophix.com/assets/images/ads/prophix-logo.svg' alt='Prophix' width="120" height="80"></amp-img>
        </div>
    ...
    <div id='copy_container_datum'>
        <div id='copy_container'>
            <div id='copy_container_mask'>
                    <div class='copy copy_color_font copy_fade_end_3'>
                        <amp-fit-text min-font-size="6" max-font-size="24" layout="fill">{{ copy }}</amp-fit-text>
                    </div>
        ...
        <div id="cta_container">
            <div id="cta_text_container">
                <amp-fit-text id="cta" min-font-size="8" max-font-size="12" layout="fill">{{ cta }}</amp-fit-text>
            </div>
        </div>

    <div id="image_container_datum">
        <div id="image_container" class='image-wrapper1'>
                <amp-img class="image" id="image_1" src="{{ img }}" width="182" height="88"></amp-img>
                <amp-img class="image" id="image_2" src="{{ img }}" width="182" height="88"></amp-img>
        </div>
    </div>
</div>
</body>
