...
<div id="container">
        <div id="logo_container">
            <amp-img id="logo" src='http://go.prophix.com/assets/images/ads/prophix-logo.svg' alt='Prophix' width="125" height="36"></amp-img>
        </div>
        ...
        <div id='copy_container'>
            <div id='copy_container_mask'>
                    <div class='copy copy_color_font copy_fade_end_3'>
                        <amp-fit-text min-font-size="6" max-font-size="17" layout="fill">
                        {{ copy }}</amp-fit-text>
                    </div>
    ...
    <div id="image_container_datum">
        <div id="image_container" class='image-wrapper1'>
                <amp-img class="image" id="image_1" src="{{ img }}" width="140" height="248"></amp-img>
                <amp-img class="image" id="image_2" src="{{ img }}" width="140" height="248"></amp-img>
        </div>
    </div>
</div>
</body>
