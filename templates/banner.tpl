...
<html amp4ads lang="en">
	...
	<style amp4ads-boilerplate>body{visibility:hidden}</style>
        ...
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Montserrat:300,300i,400,400i,500,500i,600,600i,700,700i&amp;display=swap&amp;subset=latin-ext" type="text/css" media="all">
    ...
    <body>
        <div id="container">
                <div id="logo_container">
                    <amp-img id="logo" src='http://go.prophix.com/assets/images/ads/prophix-logo.svg' alt='Prophix' width="80" height="60"></amp-img>
                </div>
            ...
            <div id="image_container_datum">
                <div id="image_container" class='image-wrapper1'>
                        <amp-img class="image" id="image_1" src="{{ img }}" width="100" height="58"></amp-img>
                        <amp-img class="image" id="image_2" src="{{ img }}" width="100" height="58"></amp-img>
                </div>
            </div>
        </div>
    </body>
